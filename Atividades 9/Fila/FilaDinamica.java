...
public class FilaDinamica {
    ...
    public void enfileirar(int dado) {
        ...
        JOptionPane.showMessageDialog(null, dado + " Foi Enfileirado Na Fila.");
    }

    public void desenfileirar() {
        if (estaVazia()) {
            JOptionPane.showMessageDialog(null, "A Fila Está Vazia. Não É Possível Desenfileirar.");
            return;
        }
        ...
        JOptionPane.showMessageDialog(null, dado + " Foi Desenfileirado Da Fila.");
    }
